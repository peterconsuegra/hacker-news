...
ActiveRecord::Schema.define(version: 2019_04_15_114424) do
  ...
  create_table "categories_links", id: false, force: :cascade do |t|
    ...
    t.index ["category_id"], name: "index_categories_links_on_category_id_and_category_id"
    t.index ["link_id"], name: "index_categories_links_on_link_id_and_link_id"
  end
